    ...
    def final(self):
        ...
        for i in range(self.NR_LINII):
            for j in range(self.NR_COLOANE - 3):
                if self.matr[i][j] == self.matr[i][j + 1] == self.matr[i][j + 2] == self.matr[i][j + 3] and \
                        self.matr[i][j] != '#':
        ...
        for j in range(self.NR_COLOANE):
            for i in range(self.NR_LINII - 3):
                if self.matr[i][j] == self.matr[i + 1][j] == self.matr[i + 2][j] == self.matr[i + 3][j] and \
                        self.matr[i][j] != '#':
                    return self.matr[i][j]
        ...
        for i in range(self.NR_LINII):
            for j in range(self.NR_COLOANE):
                diagonala=self.get_diagonala(i,j)
        ...
        for i in range(self.NR_LINII):
            for j in range(self.NR_COLOANE):
                ...
                if len(set(diagonala2)) == 1 and diagonala2[0] != '#':
                    return diagonala2[0]
    ...
    def nr_intervale_deschise(self, jucator):
        ...
        for i in range (self.NR_LINII):
            for j in range (self.NR_COLOANE-3):
                ...
                for k in range (j,j+4):
                    l.append(self.matr[i][k])
                if juc_opus not in l:
                    rez+=1
        ...
        for i in range (self.NR_LINII):
            for j in range (self.NR_COLOANE):
                ...
                if juc_opus not in diagonala and len(diagonala)>0:
                    rez+=1

                if juc_opus not in diagonala2 and len(diagonala2)>0:
                    rez+=1
