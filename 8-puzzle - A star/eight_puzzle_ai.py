...
class Graf:
    ...
    def dist_euristica(self, elem, i_elem, j_elem, reprezentare):
        poz_elem_scop=reprezentare.index(elem)
        i_scop = poz_elem_scop // Nod.NR_COLOANE
        j_scop = poz_elem_scop % Nod.NR_COLOANE
        return abs(i_elem-i_scop)+abs(j_elem-j_scop)
            ...
            if (not nod_curent.contine_in_drum(nod)):
                ...
                if x is not None:
                    ...
                    if x is not None:
                        ...
                        #nod_graf, succesori=[], parinte=None, g=0, f=None
